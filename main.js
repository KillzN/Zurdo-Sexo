...
import Pino from 'pino'
import { ZurdoJadiBot } from './plugins/jadibot-serbot.js'
...
ZurdoJadiBot({pathZurdoJadiBot: botPath, m: null, conn, args: '', usedPrefix: '/', command: 'serbot'})
}
}
}
}
